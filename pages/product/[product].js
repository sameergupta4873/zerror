              ...
              <div className="flex flex-wrap -mx-4">
                <div className="w-full px-4">
                  <ul className="flex flex-wrap items-center mb-16">
                    ...
                    <li className="mr-6">
                      <Link className="flex items-center text-sm font-medium text-gray-400 hover:text-gray-500" href="/products">
                        <span>Products</span>
                        <svg className="ml-6" width="4" height="7" viewbox="0 0 4 7" fill="none" xmlns="http://www.w3.org/2000/svg">
                          <path d="M0.150291 0.898704C-0.0500975 0.692525 -0.0500975 0.359292 0.150291 0.154634C0.35068 -0.0507836 0.674443 -0.0523053 0.874831 0.154634L3.7386 3.12787C3.93899 3.33329 3.93899 3.66576 3.7386 3.8727L0.874832 6.84594C0.675191 7.05135 0.35068 7.05135 0.150292 6.84594C-0.0500972 6.63976 -0.0500972 6.30652 0.150292 6.10187L2.49888 3.49914L0.150291 0.898704Z" fill="currentColor"></path>
                        </svg>
                    ...
                    <li><Link className="text-sm font-medium text-red-500 hover:text-red-600" href="#">{id ? products[id-1].name : 'product' }</Link></li>
                  </ul>
                </div>
                <div className="w-full lg:w-1/2 px-4 mb-16 lg:mb-0">
                  <div className="flex -mx-4 flex-wrap items-center justify-between lg:justify-start lg:items-start xl:items-center">
                    ...
                    <div className="w-full sm:w-9/12 px-4">
                      <img className="mb-5" src={'/'+products[id-1].imageSrc} alt=""/>
                ...
                <div className="w-full lg:w-1/2 px-4">
                  <div className="max-w-md mb-6">
                    <h2 className="mt-6 mb-4 text-4xl font-heading font-medium"></h2>
                    <p className="flex items-center mb-6">
                      <span className="mr-2 text-sm text-red-600 font-medium">₹</span>
                      <span className="text-3xl text-red-600 font-medium">5</span>
                    </p>
                  ...
                  {/* <div className="mb-10">
                    ...
                    <input className="w-24 px-3 py-2 text-center bg-white border-2 border-black outline-none focus:ring-2 focus:ring-red-700 focus:ring-opacity-50 rounded-xl" type="text" placeholder="1"/>
                  </div> */}
                  <div className="flex flex-wrap -mx-2 mb-12">
                    <div className="w-full md:w-2/3 px-2 mb-2 md:mb-0"><Link className="block py-4 px-2 leading-8 font-heading font-medium tracking-tighter text-xl text-white text-center bg-black focus:ring-2 focus:ring-black focus:ring-opacity-50 rounded-xl" href="#">Buy Now</Link></div>
                  </div>
