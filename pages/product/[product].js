              ...
              <div class="flex flex-wrap -mx-4">
                <div class="w-full px-4">
                  <ul class="flex flex-wrap items-center mb-16">
                    <li class="mr-6">
                      <Link class="flex items-center text-sm font-medium text-gray-400 hover:text-gray-500" href="/">
                        <span>Home</span>
                    ...
                    <li class="mr-6">
                      <Link class="flex items-center text-sm font-medium text-gray-400 hover:text-gray-500" href="/products">
                        <span>Products</span>
                        <svg class="ml-6" width="4" height="7" viewbox="0 0 4 7" fill="none" xmlns="http://www.w3.org/2000/svg">
                          <path d="M0.150291 0.898704C-0.0500975 0.692525 -0.0500975 0.359292 0.150291 0.154634C0.35068 -0.0507836 0.674443 -0.0523053 0.874831 0.154634L3.7386 3.12787C3.93899 3.33329 3.93899 3.66576 3.7386 3.8727L0.874832 6.84594C0.675191 7.05135 0.35068 7.05135 0.150292 6.84594C-0.0500972 6.63976 -0.0500972 6.30652 0.150292 6.10187L2.49888 3.49914L0.150291 0.898704Z" fill="currentColor"></path>
                        </svg>
                    ...
                    <li><Link class="text-sm font-medium text-red-500 hover:text-red-600" href="#">{id ? products[id-1].name : 'product' }</Link></li>
                  </ul>
                </div>
                <div class="w-full lg:w-1/2 px-4 mb-16 lg:mb-0">
                  <div class="flex -mx-4 flex-wrap items-center justify-between lg:justify-start lg:items-start xl:items-center">
                    <div class="w-full sm:w-auto min-w-max px-4 text-center flex sm:flex-col items-center justify-center">
                      <Link class="inline-block sm:mb-12 mr-4 sm:mr-0 transform -rotate-90 sm:transform-none hover:text-darkBlueGray-400" href="#">
                      ...
                      <Link class="h-30 block mb-4 mr-2 sm:mr-0" href="#">
                        <img class="h-20 w-16" src={'/'+products[id-1].imageSrc} alt=""/>
                      </Link>
                      <Link class="hidden sm:block h-30 mb-4 mr-2 sm:mr-0" href="#">
                        <img class="h-20 w-16" src={'/'+products[id-1].imageSrc} alt=""/>
                      </Link>
                      <Link class="hidden sm:block h-30 mb-4 mr-2 sm:mr-0 rounded-xl border-2 border-blueGray-500" href="#">
                        <img class="h-20 w-16" src={'/'+products[id-1].imageSrc} alt=""/>
                      </Link>
                      <Link class="h-30 block mb-4 sm:mb-12 mr-4 sm:mr-0" href="#">
                        <img class="h-20 w-16" src={'/'+products[id-1].imageSrc} alt=""/>
                      </Link>
                      <Link class="inline-block transform -rotate-90 sm:transform-none hover:text-darkBlueGray-400" href="#">
                        <svg width="12" height="8" viewbox="0 0 12 8" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <div class="w-full lg:w-1/2 px-4">
                  ...
                  <div class="flex flex-wrap -mx-2 mb-12">
                    <div class="w-full md:w-2/3 px-2 mb-2 md:mb-0"><Link class="block py-4 px-2 leading-8 font-heading font-medium tracking-tighter text-xl text-white text-center bg-black focus:ring-2 focus:ring-black focus:ring-opacity-50 rounded-xl" href="#">Buy Now</Link></div>
                  </div>
