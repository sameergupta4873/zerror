            ...
            <div className='my-10 mb-24 mx-[8rem]'>
                <div className="grid grid-cols-1 gap-y-10 gap-x-16 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-3 xl:gap-x-16">
                    {products.map((product) => (
                        <Link key={product.id} className={`h-30 block mb-4 mr-5 pt-20 pb-9 px-16 rounded-[25px] w-[90%]`} href={product.href} style={{ backgroundColor: product.bg }}>
                            <img className="h-[22rem] w-[20rem] transition duration-500 hover:scale-110" src={'/' + product.imageSrc} alt="" />
